...
Temos o objetivo de identificar se é estatisticamente significante o uso de sobredoses de vitamina B12 para diminuição da aterosclerose (nossa variável resposta). logo nosso experimento tenta identificar se o uso de sobredose de vitamina B12 aumenta o diâmetro da artéria (em mm) já que a doença faz com que essas artérias intupam com o progresso da doença.
