...
O teste de shapiro, teste para normalidade,  considera as seguintes hipóteses: 

 $$\begin{cases}
 H_{0}: \mbox{A amostra provém de uma população Normal} \\ 
  H_{1}: \mbox{A amostra não provém de uma população Normal} 
\end{cases}$$
