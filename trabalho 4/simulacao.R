...
#Fator A = Velocidade da Mesa (3 níveis: lento (.025 m / s), normal (.075 m / s) e rápido (.125 m / s))
...
# Y_(ijkl) = mu + tal_i + beta_j + fi_k  + (tal*beta)_ij + (beta*fi)_jk + (tal*fi)_ik + Erro_lijk
# onde (tal*fi)_ik = 0 para todo i,k
