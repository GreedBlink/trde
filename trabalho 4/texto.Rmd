...
Fazendo uma pequena mudança para obter os 
...
Interessnate notar que o uso da luva não é significativo para o experimento, resultado que corrobora a simulação feita. Com o teste, e a regra de rejeição da hipótese nula, temos que as diferências que possuem o 0 no intervalo não são significativos.
